...
class ConsultaMedica:
      ...
      def __init__(self,data_consulta,medico,paciente, cpf_paciente):
        ...
        dataAtual = datetime.strptime(self.__data_consulta,"%d/%m/%Y").date()
      ...
      def __str__(self):
          return f'data da consulta: {self.__data_consulta} {ConsultaMedica.dia_semana[self.__data_consulta.weekday()]}'
      ...
      @pago.setter
      def pago(self,cpf_cliente):
        if self.__cpf_paciente == cpf_cliente:
          self.__pago == True
